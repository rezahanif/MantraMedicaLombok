...
export const treatments: Treatment[] = [
  {
    ...
    hours: "08.00 - 17.00",
    desc: 'Our specialized massage techniques focus on deep tissue recovery. Whether you are dealing with "hiker\'s legs" or general muscle fatigue, our therapists use a medical-grade understanding of anatomy to release tension and restore mobility.',
    cta: "Book Now",
